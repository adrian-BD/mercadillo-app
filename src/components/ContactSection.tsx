...
export function ContactSection() {
  return (
    <section id="contacto" className="relative py-16 px-6 bg-[#1E3A8A] text-white overflow-hidden">
      ...
      {/* Logo Marca de Agua - Opción A (Izquierda) */}
      <img 
        src="/mercadillo.png" 
        alt="" 
        className="absolute -bottom-10 -left-10 w-72 h-72 opacity-[0.05] pointer-events-none transform rotate-12 select-none"
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start mb-16">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold border-b border-white/10 pb-2 inline-block">Contacto</h2>
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-white/80 break-all">adriandigital2026@gmail.com</p>
              </div>
            </div>
          ...
          {/* 2. Horarios */}
          <div className="space-y-6">
            <h2 className="text-2xl font-bold border-b border-white/10 pb-2 inline-block">Horarios</h2>
          ...
          {/* 3. Quiénes somos / CTA */}
          <div className="bg-[#E2725B] rounded-2xl p-6">
            ...
            <a
              ...
              className="inline-block w-full text-center bg-white text-[#E2725B] px-6 py-3 rounded-full font-semibold hover:bg-white/90 transition-colors"
            >
